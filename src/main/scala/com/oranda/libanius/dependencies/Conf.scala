...
object Conf {
  ...
  def setUp() = {
    ...
    new Conf(
      ...
      enablePersistence = config.getBoolean("libanius.enablePersistence"),
      numEventsBetweenSnapshots = config.getInt("libanius.numEventsBetweenSnapshots"),
...
class Conf(
  ...
  val numEventsBetweenSnapshots: Int,
  val email: String,
